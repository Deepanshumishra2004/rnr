...
export const ErrorView=({ message } : StateViewProps)=>{
    return (
        <div className="flex flex-col justify-center items-center h-full flex-1 gap-y-4">
            <AlertTriangleIcon className="size-6 animate-bounce text-primary" />
            {!!message && (
                <p className="text-sm text-muted-foreground">
                    { message }
                </p>
...
export function EntityList<T>({ items, renderItems, getKey, emptyView, className } : EntityListProps<T>){
    ...
    return (
        <div className={cn(
            "flex flex-col gap-y-4  py-3 px-3 rounded-md",
            className
        )}>
